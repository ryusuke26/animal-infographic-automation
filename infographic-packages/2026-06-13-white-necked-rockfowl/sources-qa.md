# Sources QA: Picathartes gymnocephalus
...
Package status at Evidence Lock: locked before image generation

## Topic And Region Lock

Recent 8 completed packages reviewed from `infographic-packages/INDEX.md`:

| Date | Topic | Broad region |
|---|---|---|
| 2026-06-05 | Lord Howe Island Stick Insect | Australia/Oceania |
| 2026-06-06 | Devil's Fingers | Australia/Oceania |
| 2026-06-07 | Honduran White Bat | Central America/Caribbean |
| 2026-06-08 | Pyrenean Desman | Europe |
| 2026-06-09 | Low's Pitcher Plant | Asia |
| 2026-06-10 | Giant Larvacean | Ocean/Global |
| 2026-06-11 | Rubber Boa | North America |
| 2026-06-12 | Queen of the Andes | South America |

Region counts: Australia/Oceania 2; Central America/Caribbean 1; Europe 1;
Asia 1; Ocean/Global 1; North America 1; South America 1; Africa 0. The
previous run was South America. Australia/Oceania remains on cooldown.

| Candidate | Region | Lineage | Habitat | Hook | Decision |
|---|---|---|---|---|---|
| White-necked Rockfowl, *Picathartes gymnocephalus* | Africa | Passerine bird | Rocky Upper Guinea forest | Bare yellow head and mud cup nests on rock | Selected: unused recent region, no bird in the previous 8, and a distinct rock-nesting hook. |
| Nimba Viviparous Toad, *Nimbaphrynoides occidentalis* | Africa | Amphibian | Montane grassland | Live-bearing toad | Held: recent archive already includes several frogs and image-safe taxonomy would require more reconciliation. |
| Giant Pangolin, *Smutsia gigantea* | Africa | Mammal | Tropical forest | Large overlapping scales and termite feeding | Held: mammal lineage is more recent and accurate scale anatomy is a higher Image Gen risk. |

## Evidence Lock

| Claim | Verdict | Publication-safe wording | Source |
|---|---|---|---|
| Accepted scientific name | accurate | Use *Picathartes gymnocephalus* (Temminck, 1825). | GBIF Backbone Taxonomy, checked 2026. |
| English common name | accurate | Use `White-necked Rockfowl`; `White-necked Picathartes` is an accepted alternative. | GBIF; Cornell Birds of the World visual account. |
| Japanese display name | needs context | Use `ハゲチメドリ`, a Japanese common name recorded by GBIF. It is not independently claimed here as a formally standardized Japanese name. | GBIF common-name record. |
...
| Population numbers | not used | No population estimate in public copy. | Not needed for the discovery-first package. |

## Locked Public Claims

1. *Picathartes gymnocephalus* is native to rocky forests of West Africa.
2. Adults have a bare yellow head with large black facial patches, a white
   neck and underside, dark upperparts, long legs, and a long tail.
3. The bird builds a deep mud cup nest attached beneath a protected rock
   surface such as a cave wall, cliff, or overhang.

## Locked Footer

Japanese and English posters:

```text
IUCN Red List 2018: Vulnerable (VU)
```

The assessment year is mandatory because the formal global assessment is dated.
...
penguin, extra legs, duplicated tail, spread-wing flight, exposed tree nest,
hanging woven nest, fake map, people, population counters, rescue imagery, or
unsupported eggs and chicks.

## Claim Check Verdict

Overall: Ready for Copy Lock and visual production.
...
- BirdLife International. 2018. [*Picathartes gymnocephalus*](https://www.iucnredlist.org/species/22692100/132172250). The IUCN Red List of Threatened Species 2018: e.T22692100A132172250. Global VU assessment, range, habitat, and conservation context.
- [IUCN assessment DOI](https://doi.org/10.2305/IUCN.UK.2018-2.RLTS.T22692100A132172250.en), checked 2026-06-13.
