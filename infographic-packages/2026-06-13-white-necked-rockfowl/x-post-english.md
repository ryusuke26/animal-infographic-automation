...
```text
Under a forest rock ledge, a small cup is built from mud.
White-necked Rockfowl
Picathartes gymnocephalus

This unusual bird lives in rocky forests of West Africa.
It has a bare yellow head, black facial patches, white underparts, and a long tail.
Pairs attach deep mud cup nests to protected cave, cliff, or overhang surfaces.
...
```text
Source context: GBIF, the IUCN Red List 2018 assessment, Thompson 2004, the BirdLife action plan, and Cornell Birds of the World were checked.
```
