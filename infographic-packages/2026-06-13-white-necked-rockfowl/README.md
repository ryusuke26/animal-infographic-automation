...
Status: completed; corrected revision published
...
- GitHub publication: corrected images, posting assets, source guidance, and
  strict future `4:5` workflow published to `origin/master`.
