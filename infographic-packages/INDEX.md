...
| 2026-05-30 | Velvet Worm / カギムシの一種 | *Euperipatoides rowelli* | `2026-05-30-velvet-worm` | completed | Package-local `images/` contains Image Gen raster PNGs plus text-safe SVG/PNG backups. Public copy uses IUCN Red List checked 2026: Not Evaluated (NE), treats カギムシの一種 as a broad Japanese label, and avoids population, trend, threat, and fake-map claims. Avoid repeat. |
| 2026-05-31 | Scaly-foot Snail / スケーリーフット | *Chrysomallon squamiferum* | `2026-05-31-scaly-foot-snail` | completed | Package-local `images/` contains Image Gen raster PNGs plus text-safe SVG/PNG backups. Public copy uses IUCN Red List 2019 EN, notes Indian Ocean hydrothermal-vent life, iron-bearing foot scales, and symbiotic bacteria without population numbers, maps, or urgency slogans. Avoid repeat. |
| 2026-06-01 | Oilbird / アブラヨタカ | *Steatornis caripensis* | `2026-06-01-oilbird` | completed | Package-local `images/` contains Image Gen raster PNGs plus text-safe SVG/PNG backups. Public copy uses IUCN Red List 2016 LC, notes cave roosting, fruit foraging, and clicking in darkness without population numbers, maps, or threat claims. Avoid repeat. |
| 2026-06-02 | Greater Bilby / ミミナガバンディクート | *Macrotis lagotis* | `2026-06-02-greater-bilby` | completed | Package-local `images/` contains Image Gen raster PNGs plus text-safe SVG/PNG backups. Public copy uses IUCN Red List 2016 VU, notes arid Australian burrow life, long ears, digging for insects/seeds, and spiral burrows without population numbers, maps, or threat-heavy framing. Avoid repeat. |
| 2026-06-03 | Hairy Frog / ケガエル | *Trichobatrachus robustus* | `2026-06-03-hairy-frog` | completed | Package-local `images/` contains Image Gen raster PNGs plus text-safe SVG/PNG backups. Public copy uses IUCN Red List 2017 LC, notes Central African forest-stream life, male hair-like skin papillae, and hidden bony toe claws without population numbers, fake maps, or horror framing. AMNH ASW accepted-name caveat: *Astylosternus robustus*. Avoid repeat under both names. |
| 2026-06-04 | Elephantnose Fish / エレファントノーズフィッシュ | *Gnathonemus petersii* | `2026-06-04-elephantnose-fish` | completed | Package-local `images/` contains Image Gen raster PNGs plus text-safe SVG/PNG backups. Public copy uses IUCN Red List 2019 LC, notes West/Central African dim riverbed life, lower-jaw chin organ, and weak-electric sensing without population numbers, fake maps, pet-care framing, or threat-heavy wording. Avoid repeat. |
