...
- Art direction restored by user request on 2026-09-17: future posters follow the production policy's crayon / oil-pastel sketch medium and existing style benchmark, with explicit visual acceptance before the English companion.
- This policy restoration does not redraw or reopen accepted historical packages; the current package state below is preserved.
...
- Package: `2026-09-17-bullocks-mountains-false-toad`.
...
- Naming caveat: ブロックヤマモドキヒキガエル is a transparent Japanese rendering, not a claimed standardized Japanese national-list name.
- Evidence note: the official page was directly inspectable. Its 2015 assessment is marked `Needs updating`; no population total is used.

## Recent-Eight Completed Region Rotation

1. 2026-09-10 — Oceania — Canterbury Knobbled Weevil
2. 2026-09-11 — Oceania — Barbie Pagoda
3. 2026-09-12 — Africa — Wood's Cycad
4. 2026-09-13 — Southeast Asia — Negros Bleeding-heart
5. 2026-09-14 — East Africa — Nguru Spiny Pygmy Chameleon
6. 2026-09-15 — Oceania — Kauaʻi Cave Wolf Spider
7. 2026-09-16 — Oceania — Pink Handfish
8. 2026-09-17 — South America — Bullock's Mountains False Toad

Oceania four; Africa and East Africa two combined; Southeast Asia one; South America one.

## Recent-Eight Completed Classification Rotation

1. 2026-09-10 — Insects — Canterbury Knobbled Weevil
2. 2026-09-11 — Fungi and lichens — Barbie Pagoda
3. 2026-09-12 — Plants — Wood's Cycad
4. 2026-09-13 — Birds — Negros Bleeding-heart
5. 2026-09-14 — Reptiles — Nguru Spiny Pygmy Chameleon
6. 2026-09-15 — Other invertebrates — Kauaʻi Cave Wolf Spider
7. 2026-09-16 — Fishes — Pink Handfish
8. 2026-09-17 — Amphibians — Bullock's Mountains False Toad

Insects, Fungi and lichens, Plants, Birds, Reptiles, Other invertebrates, Fishes and Amphibians occupy one slot each. Mammals are absent. Rotation remains only a tie-breaker after duplicate, unfamiliarity, discovery, evidence, naming and visual-viability screening.

## Daily Quality Loop

- One nominally targeted Image Gen cleanup redrew `99.85778%` of the Japanese canvas and was rejected. A local text-safe repair changed only the upper-right defect region; the English diagnostic redraw was likewise rejected and the accepted first companion preserved.
- This run creates no unresolved carryover and no policy change.
